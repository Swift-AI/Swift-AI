...
// Some examples are follow-ups to the OSX examples, such as plotting 2D functions.

import XCPlayground

// NOTE: For viewing graphs, you may need to open the Assistant Editor ->
...
func plotSineWave() {
    ...
    let network = FFNN(inputs: 1, hidden: 8, outputs: 1, learningRate: 0.7, momentum: 0.2, weights: weights)
