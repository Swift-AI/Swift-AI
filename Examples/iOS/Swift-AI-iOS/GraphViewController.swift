...
class GraphViewController: UIViewController {
    ...
    fileprivate func updateFunctionLabel() {
        let frequencyString = self.functionMultiplier.toString(decimalPlaces: 1)
        let phaseString =  (self.functionOffset > 0.0) ? " + " + self.functionOffset.toString(decimalPlaces: 1) + "π" : ""
